...
def build_search_text(attributes: ProductAttributes, listing: ProductListing) -> str:
    """Pure string logic, no AI call. Feeds the embedding step."""
    parts = [
        listing.title,
    ...
    return " ".join(text.lower().split())  # collapse whitespace
